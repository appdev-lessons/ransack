...
The [Ransack gem](https://activerecord-hackery.github.io/ransack/) provides us with a powerful, flexible, easy-to-integrate search/filter form.
...
and then `bundle install`. Restart your `bin/dev` server.
